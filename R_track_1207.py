...
def candy_to_trd(candy_tickers=['GS','SGMO']):
    ...
    candy_date=datetime.datetime.today()-datetime.timedelta(7)  #whitin 7 days
...
#    from R_options import get_option_simple
    ...
    if set(['level_0']).issubset(dt_all.columns):    
        dt_all.drop(['level_0'],axis=1, inplace=True)
#    dt_all.drop(['level_0','index','Unnamed: 0' ],axis=1, inplace=True)
...
#    try:
#        dt_hist.drop(['level_0','index','Unnamed: 0' ],axis=1, inplace=True)
#
#    except:
#        pass
